			...
			<form method="post">
				...
				<div class="mb-3">
					...
					<spring:bind path="study.name">
						<input type="text" class="form-control" id="studyName" name="<c:out value="${status.expression}"/>" value="<c:out value="${status.value}"/>" />
				...
				<div class="mb-3">
					...
					<spring:bind path="study.notes">
						<textarea class="form-control" id="studyNotes" rows="4" name="<c:out value="${status.expression}"/>">${status.value}</textarea>
						<span class="fieldError text-danger"><c:out value="${status.errorMessage}"/></span>
					</spring:bind>
				</div>
				<div class="mb-3">
