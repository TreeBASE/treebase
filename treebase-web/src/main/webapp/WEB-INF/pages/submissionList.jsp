...
<div class="container">
	...
	<div class="alert alert-info d-flex align-items-start mb-4" role="alert">
		...
		<div>
			<p class="mb-0">The table below shows a list of your TreeBASE submissions. Submissions can only be deleted after all trees and matrices are deleted first.</p>
		</div>
	</div>
	...
	<div class="card mb-4">
		<div class="card-header d-flex justify-content-between align-items-center">
			...
			<tb:helpButton topic="submissionList"/>
		</div>
		<div class="card-body">
...
<c:if test="${not empty sessionScope.importStatus}">
	<div class="card">
		<div class="card-header d-flex justify-content-between align-items-center">
			...
			<tb:helpButton topic="dryadImport"/>
		</div>
