...
<p><span>Primary access to the
database is through its web interface, where users most commonly search on
authors, citations, and taxa. Datasets are downloadable in NEXUS and NeXML
formats for further analysis.</span></p>

<p>&nbsp;</p>

<p><span>TreeBASE can be
accessed programmatically through a stateless web service interface and URL
architecture.</span>&nbsp; This interface can deliver data in several different
formats, including NEWICK, NEXUS, JSON, NeXML.</p>

<p>&nbsp;</p>

<p><b>Programmatic Data Access</b></p>

<p>In addition to the web interface, there are several forms of
programmatic access to the contents:</p>
...
<p><br>
<span>TreeBASE stores references to and provides
outlinks to external objects including DOIs (for publications), NameBankIDs and
NCBI taxids (for taxa), and Genbank accession numbers (for sequences).&nbsp;</span><br>
<br>
<i><u>Links to objects within TreeBASE</u></i><br>
<br>
...
<table border=0 cellspacing=0 cellpadding=0 width=600
 ...
 <tr>
  ...
  <p>http://purl.org/phylo/treebase/phylows/study/TB2:S1925</p>
  </td>
 </tr>
 <tr>
  <td width=100 style='width:60.0pt;padding:1.8pt 1.8pt 1.8pt 1.8pt'>
  ...
  <td width="50%" style='width:50.0%;padding:1.8pt 1.8pt 1.8pt 1.8pt'>
  <p>http://purl.org/phylo/treebase/phylows/matrix/TB2:M2610</p>
  </td>
 </tr>
 <tr>
  <td width=100 style='width:60.0pt;padding:1.8pt 1.8pt 1.8pt 1.8pt'>
  ...
  <td width="50%" style='width:50.0%;padding:1.8pt 1.8pt 1.8pt 1.8pt'>
  <p>http://purl.org/phylo/treebase/phylows/tree/TB2:Tr2026</p>
  </td>
 </tr>
</table>
...
<span>When TreeBASE's API delivers a list of results
...
taxon of interest will alert the user with a new RSS article.&nbsp;</span></p>
...
entire periodic data dumps that comply<span style='background:white'> with a
standard data model, such as BioSQL.</span></p>
