...
<link rel="stylesheet" type="text/css" href="<c:url value='/styles/treebase.css'/>" />
...
<nav class="navbar navbar-expand-lg treebase-navbar">
	<div class="container-fluid">
		...
		<div class="collapse navbar-collapse" id="mainNavbar">
			<div class="ms-auto">
				<a class="btn btn-outline-light btn-sm" href="<c:url value="/search/studySearch.html"/>"><fmt:message key="nav.search.treebase"/></a>
			</div>
		</div>
	</div>
</nav>
...
<div class="container-fluid">
	<div class="row">
		<!-- Left Sidebar -->
		<div class="col-12 col-md-3 p-0" id="sidebarLeft">
			<c:import url="/common/sidebarLeft.jsp"/>
		</div>
		<!-- Main Content -->
		<main class="col-12 col-md-9" id="contentRight">
			<decorator:body/>
		</main>
	</div>
</div>
