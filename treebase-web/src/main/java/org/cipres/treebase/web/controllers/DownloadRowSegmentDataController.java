 ...
 * 
 */
public class DownloadRowSegmentDataController implements Controller {
	...
	public ModelAndView handleRequest(HttpServletRequest request, HttpServletResponse response)
		...
		String matrixId = param.get("matrixid")[0];
		String data = null;
		...
		String downloadDir = request.getSession().getServletContext().getRealPath(
			...
			+ TreebaseUtil.FILESEP + "temp_rowsegment";

		String fileName = "RowSegmentData_" + matrixId + ".tsv";
		...
		String rowsegmentFile = downloadDir + TreebaseUtil.FILESEP + fileName;

		try {

			File file = new File(rowsegmentFile);
		...
		File rowFile = new File(rowsegmentFile);
