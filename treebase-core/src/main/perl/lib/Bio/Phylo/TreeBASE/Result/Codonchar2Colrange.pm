package Bio::Phylo::TreeBASE::Result::Codonchar2Colrange;
...
__PACKAGE__->table("codonchar2_colrange");
...
__PACKAGE__->add_unique_constraint("codonchar2_colrange_columnrange_id_key", ["columnrange_id"]);
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:TUAS+irl6yprEuY0lOj5Xw
