package Bio::Phylo::TreeBASE::Result::Codonchar1Colrange;
...
__PACKAGE__->table("codonchar1_colrange");
...
__PACKAGE__->add_unique_constraint("codonchar1_colrange_columnrange_id_key", ["columnrange_id"]);
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:NJGJkVbsz3kP+Bv0Of/uSw
