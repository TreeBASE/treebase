...
public class PackageTestSuite {
	...
	public static Test suite() {
		...
		suite.addTestSuite(ItemDefinitionDAOTest.class);
		suite.addTestSuite(MatrixDAOTest.class);
		suite.addTestSuite(MatrixDataTypeDAOTest.class);
		suite.addTestSuite(MatrixElementDAOTest.class);
		suite.addTestSuite(MatrixRowDAOTest.class);
		suite.addTestSuite(RowSegmentDAOTest.class);
