...
public class PackageTestSuite {
	...
	public static Test suite() {
		...
		suite.addTestSuite(AbstractDAOTest.class);

		suite.addTest(org.cipres.treebase.dao.admin.PackageTestSuite.suite());
		suite.addTest(org.cipres.treebase.dao.matrix.PackageTestSuite.suite());
		suite.addTest(org.cipres.treebase.dao.study.PackageTestSuite.suite());
		suite.addTest(org.cipres.treebase.dao.taxon.PackageTestSuite.suite());
		suite.addTest(org.cipres.treebase.dao.tree.PackageTestSuite.suite());
