...
import org.cipres.treebase.util.HashFieldReaderTest;
...
public class PackageTestSuite {
	...
	public static Test suite() {
		...
		suite.addTest(org.cipres.treebase.service.admin.PackageTestSuite.suite());
		suite.addTest(org.cipres.treebase.service.matrix.PackageTestSuite.suite());
		suite.addTest(org.cipres.treebase.service.nexus.PackageTestSuite.suite());
		suite.addTest(org.cipres.treebase.service.study.PackageTestSuite.suite());
		suite.addTest(org.cipres.treebase.service.taxon.PackageTestSuite.suite());
		suite.addTest(org.cipres.treebase.service.tree.PackageTestSuite.suite());
