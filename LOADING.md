The steps described below follow on the [installation instructions](INSTALL.md) that set up the server application. In the
below steps, importing data from Nexus files is described. Missing from these instructions are the steps for replicating
